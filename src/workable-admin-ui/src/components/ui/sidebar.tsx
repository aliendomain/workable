...
type SidebarScrollMode = "browser" | "panel"
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        "ml-3.5 mr-0 flex min-w-0 translate-x-px flex-col gap-1 border-l border-sidebar-border py-0.5 pl-2.5 pr-0 group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
    />
