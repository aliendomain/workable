...
- `BaselineSqlScheduleQueryBenchmarks` measures the maximum 1,000-row initial and continued schedule-list provider surfaces plus a consolidated 100-row management overview command. `BaselineSqlScheduleOccurrenceQueryBenchmarks` measures bounded occurrence-history reads at configured retention scales.
