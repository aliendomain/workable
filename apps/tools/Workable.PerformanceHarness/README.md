...
- `BaselineSqlScheduleQueryBenchmarks` and `BaselineSqlScheduleOccurrenceQueryBenchmarks` measure the maximum 1,000-row schedule-list queries and bounded occurrence-history reads used by the administration UI at configured retention scales.
