...
- `BaselineSqlScheduleQueryBenchmarks` and `BaselineSqlScheduleOccurrenceQueryBenchmarks` measure the schedule-list and occurrence-history reads used by the administration UI at configured retention scales.
