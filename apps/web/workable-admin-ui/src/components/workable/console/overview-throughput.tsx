...
import {
  semanticColorValue,
  semanticDotToneClass,
  semanticGlowShadowClass,
      ...
      return [
        {
          ...
          id: "execution-average",
          label: "Avg",
          pulseClass: semanticDotToneClass("neutral"),
          value: "-",
          widthClass: "min-w-20",
        },
        {
    ...
    return [
      {
        ...
        id: "started",
        label: "",
        pulseClass: semanticDotToneClass("info"),
        value: "-",
        valueClass: semanticTextToneClass("info", "strong"),
        widthClass: "min-w-16",
      },
      {
        ...
        id: "completed",
        label: "",
        pulseClass: semanticDotToneClass("success"),
        value: "-",
        valueClass: semanticTextToneClass("success", "strong"),
        widthClass: "min-w-16",
      },
      {
        ...
        id: "failed",
        label: "",
        pulseClass: semanticDotToneClass("danger"),
        value: "-",
        valueClass: semanticTextToneClass("danger", "strong"),
        widthClass: "min-w-16",
      },
      {
        ...
        id: "canceled",
        label: "",
        pulseClass: semanticDotToneClass("warning"),
        value: "-",
        valueClass: semanticTextToneClass("warning", "strong"),
        widthClass: "min-w-16",
      },
      {
    ...
    return [
      {
        ...
        id: "execution-average",
        label: "Avg",
        pulseClass: `${semanticDotToneClass("neutral")} ${semanticGlowShadowClass("neutral")}`,
  ...
  return [
    {
      ...
      id: "started",
      label: "",
      pulseClass: `${semanticDotToneClass("info")} ${semanticGlowShadowClass("info")}`,
    ...
    },
    {
      ...
      id: "completed",
      label: "",
      pulseClass: `${semanticDotToneClass("success")} ${semanticGlowShadowClass("success")}`,
    ...
    },
    {
      ...
      id: "failed",
      label: "",
      pulseClass: `${semanticDotToneClass("danger")} ${semanticGlowShadowClass("danger")}`,
    ...
    },
    {
      ...
      id: "canceled",
      label: "",
      pulseClass: `${semanticDotToneClass("warning")} ${semanticGlowShadowClass("warning")}`,
...
export function createExecutionPressureMetric(summary: WorkThroughputLiveSummary): ThroughputMetric {
  ...
  if (deltaPerSecond > 0) {
    return {
      ...
      icon: ArrowUp,
      iconClass: semanticTextToneClass("danger", "strong"),
      id: "execution-pressure",
      label: "",
  ...
  if (deltaPerSecond < 0) {
    ...
    return {
      ...
      icon: ArrowDown,
      iconClass: semanticTextToneClass("success", "strong"),
      id: "execution-pressure",
      label: "",
