    ...
    [
        new(
            ...
            [
                ...
                Field("options.profilingCaptureMode", "Profiling capture", "Keep automatic instrumentation bounded, or request full capture when the caller also has diagnostics permission."),
